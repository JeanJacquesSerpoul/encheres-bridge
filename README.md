...
- À votre tour, une **boîte à enchères** n'ouvre que les enchères **légales** (palier suffisant, contre et surcontre selon le camp du dernier appelant). La réponse est comparée à celle du moteur : verdict, enchère attendue et son commentaire SEF, puis **Continuer**. Après une mauvaise réponse, **Voir l'arbre de décision** déplie le chemin suivi par le moteur sur la main — chaque règle examinée dans l'ordre, ✓ ou ✗, avec la valeur mesurée —, pour l'instant sur les ouvertures, les réponses sans intervention adverse, les redemandes de l'ouvreur, les interventions, les réponses à une intervention ou à un contre d'appel et la décision générale de la suite de l'enchère — manche, proposition, soutien, loi des levées totales, passe —, la réponse à une proposition de manche, l'exploration du chelem — contrôles, Blackwood —, les sacrifices, Roudi, Checkback, l'essai en couleur d'aide, les troisième et quatrième couleurs forcing, le bicolore cher, la réponse après une intervention adverse et la réouverture de l'ouvreur , le réveil, la réponse au 2 faible, au Michaels et au contre Spoutnik, les suites du Texas, du Stayman et de l'ouverture de 2♣, Rubensohl, Drury, les paliers d'As sur 2♦ fort, le relais 2SA sur un 2 faible , Landy, les suites du Stayman aux deux majeures et de la misère dorée, la seconde majeure du répondant et les autres gestionnaires de la suite de l'enchère — 99,7 % des enchères ; une poignée de cas isolés n'ont pas encore d'arbre (voir le champ `trace` ci-dessous) ; le même lien figure dans le récapitulatif de fin.
...
| `auction[].trace` | Chemin de décision de l'enchère, évalué sur la main (absent tant que la situation n'est pas instrumentée — pour l'instant les ouvertures, les réponses sans intervention — 1 en majeure, 1 en mineure, 1SA, 2SA, relais sur 2♣ — les redemandes de l'ouvreur après une ouverture d'1 à la couleur, un Stayman, un Texas majeur ou le relais sur 2♣, les interventions (couleur, 1SA, contre, Michaels, Landy) les réponses à une intervention à la couleur ou à Sans-Atout et au contre d'appel, et la décision générale de la suite de l'enchère sur la force combinée — manche, proposition de manche, soutien simple, loi des levées totales, préférence, passe — la réponse à une proposition de manche, l'exploration du chelem (soutien forcing avant les contrôles, enchères de contrôle et leur poursuite, relais contrôle, lancement de Blackwood avec ou sans fit, petit chelem à Sans-Atout), Blackwood (réponse en cartes clefs, en As ou en Rois, et choix du contrat par celui qui a demandé), la compétition sur leur manche (surenchère, sacrifice selon la loi des levées totales et la marque, contre punitif de leur sacrifice), Roudi et Checkback (demande, réponse de l'ouvreur et conclusion), la réponse à un essai en couleur d'aide, les troisième et quatrième couleurs forcing (demande et réponse), la réponse au bicolore cher, la réponse à la demande de force d'une intervention, le retrait sur misfit, la réponse après une intervention adverse (majeure libre, contre Spoutnik, soutiens et loi des levées totales, changement de couleur, 1SA) et la réouverture de l'ouvreur après un passe du partenaire, ainsi que la réponse au contre forcing du partenaire, au Stayman après la redemande 2SA d'une ouverture forte et au Texas majeur tardif ; une décision confiée à une partie du moteur pas encore instrumentée ne porte pas de trace) : liste de `{label, value, ok, note, depth}` — le test dans la langue demandée, la valeur mesurée (`"14 HL"`, `"4 ♠"`), s'il tient, s'il s'agit d'une simple note (filet de sécurité, passe final), sa profondeur d'imbrication |
