...
- À votre tour, une **boîte à enchères** n'ouvre que les enchères **légales** (palier suffisant, contre et surcontre selon le camp du dernier appelant). La réponse est comparée à celle du moteur : verdict, enchère attendue et son commentaire SEF, puis **Continuer**. Après une mauvaise réponse, **Voir l'arbre de décision** déplie le chemin suivi par le moteur sur la main — chaque règle examinée dans l'ordre, ✓ ou ✗, avec la valeur mesurée —, pour l'instant sur les ouvertures, les réponses sans intervention adverse, les redemandes de l'ouvreur, les interventions et les réponses à une intervention ou à un contre d'appel (voir le champ `trace` ci-dessous) ; le même lien figure dans le récapitulatif de fin.
